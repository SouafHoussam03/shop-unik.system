    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (responseData.success) {
                toast.success(responseData.message || "Produit modifié avec succès")
                fetchdata?.()
                onClose?.()
            }

            if (responseData.error) {
                toast.error(responseData.message || "Erreur lors de la modification")
            }
        } catch (error) {
            ...
            <div className="h-[92vh] w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="h-full overflow-y-auto p-6 pb-36">
                    ...
                    <div className="mt-6 rounded-3xl border bg-white p-5">
                        ...
                        <label htmlFor="editProductImageInput">
                    ...
                    >
                        ...
                        {submitLoading ? "Modification..." : "Modifier le produit"}
                    </button>
