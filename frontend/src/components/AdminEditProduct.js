        ...
        <div className='fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-center items-center z-50 p-4'>
            ...
            <div className='bg-white rounded-3xl shadow-2xl w-full max-w-4xl h-[92vh] overflow-hidden'>
                ...
                >
                    ...
                    <button
                        type='submit'
                        className='w-full mt-10 bg-red-600 hover:bg-black text-white py-5 rounded-full text-lg font-bold transition-all duration-300 hover:scale-[1.02] shadow-lg'
                    >
                        Update Product
                    </button>
